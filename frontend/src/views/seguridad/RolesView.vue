<template>
  <div>
    <div class="page-hero">
      <VolverBtn :to="links.seguridad.modulo" />
    ...
    <div class="card-section">
      <DataTable :value="roles" stripedRows paginator :rows="10" :rowsPerPageOptions="[10, 25, 50]"
        ...
        <Column field="fecha_creacion" header="Creado" sortable><template #body="{data}">{{ soloFecha(data.fecha_creacion) }}</template></Column>
      </DataTable>
    </div>
  </div>
</template>
