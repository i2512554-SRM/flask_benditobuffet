<template>
  <div class="cocina-view">
    <VolverBtn :to="links.panel.cocinero" />
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <router-link :to="links.cocina.solicitudes" class="btn btn-outline">
    ...
    <Dialog v-model:visible="stockDialog" :header="stockModo === 'entrada' ? 'Agregar stock' : 'Registrar salida'" :modal="true" :style="{ width: '440px' }">
      <div class="formgrid grid">
        ...
        <div class="field col-12">
          ...
          <InputText id="stock-motivo" v-model="stockForm.motivo" maxlength="255" :placeholder="stockModo === 'entrada' ? 'Ej. Reposición de almacén' : 'Ej. Preparación de menú del día'" class="w-full" />
        </div>
      </div>
...
const fmtFechaHora = formatFecha
const severidad = (estado) => (estado === 'Agotado' ? 'danger' : estado === 'Stock bajo' ? 'warning' : 'success')
const solicitar = (prod) => router.push({ path: links.cocina.solicitudes, query: { producto: prod.id_producto } })
