  ...
  <div class="cocina-view">
    ...
    <div class="section-block">
      ...
      <div class="acciones-grid">
        <SolicitarAdelanto />
        <router-link :to="links.inventario.nuevo" class="btn btn-primary">
