<template>
  <div class="cajera-panel">
    ...
    <router-link :to="links.caja.reportes" class="btn btn-outline">Ver reportes financieros y detalle →</router-link>
    ...
    <CajaTransaccionDialog v-model:visible="dialogTransaccion" :tipo="tipoRegistro" @registrado="onRegistrado" />
...
const abrirCaja = async () => {
  ...
  try {
    ...
    toast.add({ severity: 'error', summary: err.response?.data?.error || 'Error abriendo la caja', life: 3500 })
  } finally {
