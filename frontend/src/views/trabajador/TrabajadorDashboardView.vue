<template>
  <div class="trabajador-view">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          ...
          <span class="stat-badge tone-purple">{{ ultimoPago.fecha ? soloFecha(ultimoPago.fecha) : 'sin pagos aún' }}</span>
        </div>
      </div>
      <div class="stat-card">
    ...
    <div class="module-grid">
      ...
      <router-link :to="links.trabajador.notificaciones" class="module-card">
    ...
    <div class="section-block" v-if="data.notificaciones?.length">
      ...
      <div class="notif-list" v-for="n in data.notificaciones" :key="n.id_notificacion">
        ...
        <div class="notif-body">
          ...
          <span class="notif-date">{{ formatFecha(n.fecha) }}</span>
        </div>
      </div>
    </div>
  </div>
