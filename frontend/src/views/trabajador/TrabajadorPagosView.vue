<template>
  <div class="trabajador-view">
    <VolverBtn :to="links.panel.trabajador" />
    ...
    <nav aria-label="Historial personal" class="page-header">
      <router-link :to="links.trabajador.pagos">Pagos y adelantos</router-link>
      <router-link :to="links.trabajador.pagosAdelantos">Solo adelantos</router-link>
    </nav>
