import { S as l, g as b, k as z, l as J, v as d } from "./object-EGs2rUUd.js";
import { B as C, Ct as x$1, J as Mt, K as L, L as x, W as Ht, Z as Pt, ct as ft, gt as oe, nt as Xt, pt as jt, rt as Y, st as et, wt as z$1, z as $t } from "./dist-2XbtBF3i.js";
...
import { t as d$1 } from "./spinner-PABJ64yc.js";
import { t as v } from "./core-U8nrK_TP.js";
import { t as script$5 } from "./basecomponent-osrtnGQp.js";
import { n as BaseStyle } from "./licenseBanner-_PSsJfq3.js";
import { t as d$2 } from "./times-D_miu6Qm.js";
import { t as script$6 } from "./portal-CXNbd7BC.js";
import { n as h$1, r as ConnectedOverlayScrollHandler, t as OverlayEventBus } from "./overlayeventbus-D5oDXtyw.js";
import { t as h$2 } from "./check-BESrWDxp.js";
import { t as script$7 } from "./baseinput-Cc_ZoxxV.js";
import { t as script$8 } from "./inputtext-CkFQUb9L.js";
...
//#endregion
//#region node_modules/@primeicons/vue/dist/esm/icons/blank.mjs
...
//#endregion
//#region node_modules/@primeicons/core/dist/esm/icons/search.mjs
var e = {
	name: "search",
	meta: { tags: [
		"search",
...
//#endregion
//#region node_modules/@primeicons/vue/dist/esm/icons/search.mjs
	...
	methods: {
		viewInit: function viewInit() {
			if (ft(this.element)) {
				...
				this.init();
				this.calculateAutoSize();
				this.defaultWidth = jt(this.element);
				this.defaultHeight = Pt(this.element);
				this.defaultContentWidth = jt(this.content);
				this.defaultContentHeight = Pt(this.content);
		...
		calculateAutoSize: function calculateAutoSize() {
			...
			if (this.autoSize && !this.d_loading) Promise.resolve().then(function() {
				if (_this4.content) {
					...
					var _ref = [jt(_this4.element), Pt(_this4.element)], width = _ref[0], height = _ref[1];
		...
		onResize: function onResize() {
			...
			this.resizeTimeout = setTimeout(function() {
				if (ft(_this0.element)) {
					var both = _this0.isBoth();
					var vertical = _this0.isVertical();
					var horizontal = _this0.isHorizontal();
					var _ref3 = [jt(_this0.element), Pt(_this0.element)], width = _ref3[0], height = _ref3[1];
					...
					if (both ? isDiffWidth || isDiffHeight : horizontal ? isDiffWidth : vertical ? isDiffHeight : false) {
						...
						_this0.defaultContentWidth = jt(_this0.content);
						_this0.defaultContentHeight = Pt(_this0.content);
						_this0.init();
					}
				}
			}, this.resizeDelay);
		...
		setContentEl: function setContentEl(el) {
			this.content = el || this.content || et(this.element, "[data-pc-section=\"content\"]");
		},
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return !_ctx.disabled ? (openBlock(), createElementBlock("div", mergeProps({
		...
		!_ctx.loaderDisabled && _ctx.showLoader && $data.d_loading ? (openBlock(), createElementBlock("div", mergeProps({
			...
			return renderSlot(_ctx.$slots, "loader", { options: $options.getLoaderOptions(index, $options.isBoth() && { numCols: _ctx.d_numItemsInViewport.cols }) }, void 0, void 0, index);
...
var script = {
	...
	updated: function updated() {
		if (this.overlayVisible && this.isModelValueChanged && !this.multiple) this.scrollInView(this.findSelectedOptionIndex());
	...
	methods: {
		...
		getOptionRenderKey: function getOptionRenderKey(option, index) {
			return (this.dataKey ? d(option, this.dataKey) : this.getOptionLabel(option)) + "_" + index;
		},
		...
		getOptionGroupLabel: function getOptionGroupLabel(optionGroup) {
			return d(optionGroup, this.optionGroupLabel);
		},
		getOptionGroupChildren: function getOptionGroupChildren(optionGroup) {
			return d(optionGroup, this.optionGroupChildren);
		},
		...
		show: function show(isFocus) {
			...
			isFocus && Ht(this.$refs.focusInput);
		},
		hide: function hide(isFocus) {
			...
			var _hide = function _hide() {
				...
				isFocus && Ht(_this2.$refs.focusInput);
			};
			setTimeout(function() {
				_hide();
			}, 0);
			...
			switch (event.code) {
				...
				default: if (!metaKey && J(event.key)) {
					...
					if (this.filter) this.$nextTick(function() {
						if (_this4.$refs.filterInput) Ht(_this4.$refs.filterInput.$el);
					});
				}
			}
			this.clicked = false;
		...
		onEditableInput: function onEditableInput(event) {
			...
			!this.overlayVisible && l(value) && this.show();
		},
		...
		onFirstHiddenFocus: function onFirstHiddenFocus(event) {
			var focusableEl = event.relatedTarget === this.$refs.focusInput ? Mt(this.overlay, ":not([data-p-hidden-focusable=\"true\"])") : this.$refs.focusInput;
			Ht(focusableEl);
		},
		onLastHiddenFocus: function onLastHiddenFocus(event) {
			var focusableEl = event.relatedTarget === this.$refs.focusInput ? $t(this.overlay, ":not([data-p-hidden-focusable=\"true\"])") : this.$refs.focusInput;
			Ht(focusableEl);
		},
		...
		onOptionSelectMultiple: function onOptionSelectMultiple(event, option) {
			...
			var newValue = this.isSelected(option) ? current.filter(function(v) {
				return !b(v, value, _this5.equalityKey);
		...
		onTabKey: function onTabKey(event) {
			if (!(arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false)) {
				if (this.overlayVisible && this.hasFocusableElements()) {
					Ht(this.$refs.firstHiddenFocusableElementOnOverlay);
					event.preventDefault();
				} else {
					if (this.focusedOptionIndex !== -1) this.onOptionSelect(event, this.visibleOptions[this.focusedOptionIndex]);
		...
		onOverlayEnter: function onOverlayEnter(el) {
			...
			setTimeout(function() {
				_this6.autoFilterFocus && _this6.filter && _this6.$refs.filterInput && Ht(_this6.$refs.filterInput.$el);
		...
		onOverlayLeave: function onOverlayLeave(el) {
			...
			if (this.autoFilterFocus && this.filter && !this.editable) this.$nextTick(function() {
				if (_this7.$refs.filterInput) Ht(_this7.$refs.filterInput.$el);
			});
			this.$emit("hide");
			this.overlay = null;
		},
		...
		alignOverlay: function alignOverlay() {
			if (this.appendTo === "self") Y(this.overlay, this.$el);
			else if (this.overlay) {
				this.overlay.style.minWidth = L(this.$el) + "px";
				z$1(this.overlay, this.$el);
			}
		},
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					...
					if (_this8.overlayVisible && _this8.overlay && !composedPath.includes(_this8.$el) && !composedPath.includes(_this8.overlay)) _this8.hide();
				};
		...
		bindScrollListener: function bindScrollListener() {
			...
			if (!this.scrollHandler) this.scrollHandler = new ConnectedOverlayScrollHandler(this.$refs.container, function() {
				if (_this9.overlayVisible) _this9.hide();
			});
		...
		bindResizeListener: function bindResizeListener() {
			...
			if (!this.resizeListener) {
				this.resizeListener = function() {
					if (_this0.overlayVisible && !oe()) _this0.hide();
				};
				window.addEventListener("resize", this.resizeListener);
			}
		},
		...
		unbindLabelClickListener: function unbindLabelClickListener() {
			if (this.labelClickListener) {
				var label = document.querySelector("label[for=\"".concat(this.labelId || this.inputId, "\"]"));
				if (label && ft(label)) label.removeEventListener("click", this.labelClickListener);
			}
		},
		...
		hasFocusableElements: function hasFocusableElements() {
			return x$1(this.overlay, ":not([data-p-hidden-focusable=\"true\"])").length > 0;
		},
		...
		isValidOption: function isValidOption(option) {
			return l(option) && !(this.isOptionDisabled(option) || this.isOptionGroup(option));
		},
		...
		isSelected: function isSelected(option) {
			...
			if (this.multiple) return Array.isArray(this.d_value) && this.d_value.some(function(v) {
				return b(v, optionValue, _this11.equalityKey);
			});
			return b(this.d_value, optionValue, this.equalityKey);
		},
		...
		findLastOptionIndex: function findLastOptionIndex() {
			var _this13 = this;
			return z(this.visibleOptions, function(option) {
		...
		findPrevOptionIndex: function findPrevOptionIndex(index) {
			var _this15 = this;
			var matchedOptionIndex = index > 0 ? z(this.visibleOptions.slice(0, index), function(option) {
		...
		searchOptions: function searchOptions(event, _char) {
			...
			var matched = false;
			if (l(this.searchValue)) {
				var optionIndex = this.visibleOptions.findIndex(function(option) {
		...
		scrollInView: function scrollInView() {
			...
			this.$nextTick(function() {
				...
				var element = et(_this18.list, "li[id=\"".concat(id, "\"]"));
				if (element) element.scrollIntoView && element.scrollIntoView({
					block: "nearest",
					inline: "nearest"
				});
				else if (!_this18.virtualScrollerDisabled) _this18.virtualScroller && _this18.virtualScroller.scrollToIndex(index !== -1 ? index : _this18.focusedOptionIndex);
			});
		},
		autoUpdateModel: function autoUpdateModel() {
			if (this.autoOptionFocus) this.focusedOptionIndex = this.findFirstFocusedOptionIndex();
			if (this.selectOnFocus && this.autoOptionFocus && !this.$filled && !this.multiple) this.onOptionSelect(null, this.visibleOptions[this.focusedOptionIndex], false);
		},
	...
	computed: {
			...
			if (this.filterValue) {
				...
				if (this.optionGroupLabel) {
					...
					optionGroups.forEach(function(group) {
						var filteredItems = _this20.getOptionGroupChildren(group).filter(function(item) {
		...
		label: function label() {
			var _this21 = this;
			if (this.multiple) {
				if (!Array.isArray(this.d_value) || this.d_value.length === 0) return this.placeholder || "p-emptylabel";
				return this.d_value.map(function(val) {
					var opt = _this21.visibleOptions.find(function(o) {
						return !_this21.isOptionGroup(o) && b(val, _this21.getOptionValue(o), _this21.equalityKey);
					});
		...
		labelDataP: function labelDataP() {
			return c(_defineProperty(_defineProperty({
		...
		overlayDataP: function overlayDataP() {
			return c(_defineProperty({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
		}
	},
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("dropdown") }, _ctx.ptm("dropdown")), [_ctx.loading ? renderSlot(_ctx.$slots, "loadingicon", { "class": normalizeClass(_ctx.cx("loadingIcon")) }, function() {
		...
		}, void 0, 0) : renderSlot(_ctx.$slots, "dropdownicon", { "class": normalizeClass(_ctx.cx("dropdownIcon")) }, function() {
									...
									return [createVNode(_component_InputText, {
										...
										"default": withCtx(function() {
											return [renderSlot(_ctx.$slots, "filtericon", {}, function() {
												...
												}, _ctx.ptm("filterIcon")), null, 16)) : (openBlock(), createBlock(_component_Search, normalizeProps(mergeProps({ key: 1 }, _ctx.ptm("filterIcon"))), null, 16))];
											})];
										}),
										_: 3
									}, 8, ["unstyled", "pt"])];
							...
							createBaseVNode("div", mergeProps({
								...
								content: withCtx(function(_ref) {
									...
									return [createBaseVNode("ul", mergeProps({
										...
										}, { ref_for: true }, $options.getPTItemOptions(option, getItemOptions, i, "option")), [_ctx.checkmark ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [$options.isSelected(option) ? (openBlock(), createBlock(_component_Check, mergeProps({
											key: 0,
											"class": _ctx.cx("optionCheckIcon")
										}, { ref_for: true }, _ctx.ptm("optionCheckIcon")), null, 16, ["class"])) : (openBlock(), createBlock(_component_Blank, mergeProps({
											key: 1,
