import { C as m, E as s$1, O as x, T as p, _ as c, r as C, t as A, u as K, x as ie } from "./object-EGs2rUUd.js";
import { K as L, Q, Z as Pt, _ as R, _t as ot, bt as st, mt as k, pt as jt, q as M, tt as W, v as S } from "./dist-2XbtBF3i.js";
import { Dt as mergeProps } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
import { n as Base } from "./basecomponent-osrtnGQp.js";
import { n as BaseStyle } from "./licenseBanner-_PSsJfq3.js";
import { t as PrimeVueService } from "./service-BPv4x_ax.js";
...
var BaseDirective = {
	_getMeta: function _getMeta() {
		return [s$1(arguments.length <= 0 ? void 0 : arguments[0]) ? void 0 : arguments.length <= 0 ? void 0 : arguments[0], x(s$1(arguments.length <= 0 ? void 0 : arguments[0]) ? arguments.length <= 0 ? void 0 : arguments[0] : arguments.length <= 1 ? void 0 : arguments[1])];
	},
	...
	_getPTDatasets: function _getPTDatasets() {
		...
		return _objectSpread(_objectSpread({}, key === "root" && _defineProperty$1({}, "".concat(datasetPrefix, "name"), C(instance.$name))), {}, _defineProperty$1({}, "".concat(datasetPrefix, "section"), C(key)));
	},
	...
	_hook: function _hook(directiveName, hookName, el, binding, vnode, prevVnode) {
		...
		var name = "on".concat(ie(hookName));
		var config = BaseDirective._getConfig(binding, vnode);
	...
	_extend: function _extend(name) {
		...
		var handleHook = function handleHook(hook, el, binding, vnode, prevVnode) {
			...
			var $options = p($prevInstance) ? _objectSpread(_objectSpread({}, options), options === null || options === void 0 ? void 0 : options.methods) : {};
...
var Ripple = BaseRipple.extend("ripple", {
	...
	methods: {
		...
		createRipple: function createRipple(el) {
			...
			if (!ink) {
				ink = Q("span", _defineProperty(_defineProperty({
					role: "presentation",
					"aria-hidden": true,
					"data-p-ink": true,
		...
		onMouseDown: function onMouseDown(event) {
			...
			!this.isUnstyled() && M(ink, "p-ink-active");
			ink.setAttribute("data-p-ink-active", "false");
			if (!Pt(ink) && !jt(ink)) {
				var d = Math.max(L(target), k(target));
				ink.style.height = d + "px";
				ink.style.width = d + "px";
			}
			var offset = st(target);
			var x = event.pageX - offset.left + document.body.scrollTop - jt(ink) / 2;
			var y = event.pageY - offset.top + document.body.scrollLeft - Pt(ink) / 2;
			ink.style.top = y + "px";
			ink.style.left = x + "px";
			...
			this.timeout = setTimeout(function() {
				if (ink) {
					!_this.isUnstyled() && M(ink, "p-ink-active");
					ink.setAttribute("data-p-ink-active", "false");
				}
			}, 401);
		},
		onAnimationEnd: function onAnimationEnd(event) {
			...
			!this.isUnstyled() && M(event.currentTarget, "p-ink-active");
			event.currentTarget.setAttribute("data-p-ink-active", "false");
		},
		getInk: function getInk(el) {
			return el && el.children ? _toConsumableArray(el.children).find(function(child) {
				return ot(child, "data-pc-name") === "ripple";
			}) : void 0;
		}
	}
});
