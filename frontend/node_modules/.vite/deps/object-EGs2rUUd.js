...
var E = (e, t) => {
	for (var n in t || (t = {})) pe.call(t, n) && q(e, n, t[n]);
	if ($) for (var n of $(t)) ge.call(t, n) && q(e, n, t[n]);
	return e;
};
function p(e) {
...
function _(e, t) {
	if (e != null && t && t.length) {
		for (let n of t) if (b(e, n)) return !0;
	}
	return !1;
}
function s(e, t = !0) {
...
function S(e, t, n, r = /* @__PURE__ */ new WeakSet()) {
	let o = E({}, e);
	...
	return u && r.add(t), Object.keys(t).forEach((i) => {
		...
		if (me.has(i)) return;
		let f = i, a = t[f];
		s(a) && f in e && s(e[f]) ? o[f] = r.has(a) ? (y = n.get(a)) != null ? y : S({}, a, n, r) : S(e[f], a, n, r) : s(a) ? o[f] = (k = n.get(a)) != null ? k : S({}, a, n, r) : o[f] = a;
	}), u && r.delete(t), o;
}
function F(...e) {
	return e.reduce((t, n) => S(t, n || {}, /* @__PURE__ */ new WeakMap()), {});
}
function D(e, t) {
	let n = -1;
	if (t) {
...
function K(e, t = "", n = {}) {
	...
	if (o) {
		if (s(e) || Array.isArray(e)) return K(x(e[Object.keys(e).find((i) => C(i) === o) || ""], n), r.join("."), n);
		return;
	}
	return x(e, n);
}
...
function oe(e, t, n = 1, r, o = 1) {
	let u = T(e, t, r, n), i = n;
	return (p(e) || p(t)) && (i = o === 1 ? n : o), i * u;
}
function ie(e) {
...
//#endregion
export { m as C, te as D, s as E, x as O, l as S, p as T, c as _, F as a, fe as b, I as c, N as d, Q as f, b as g, ae as h, D as i, z as k, J as l, _ as m, B as n, G as o, Z as p, C as r, H as s, A as t, K as u, d as v, oe as w, ie as x, ee as y };
