...
import { t as v } from "./eventbus-DioRHkzf.js";
import { et as Ut } from "./dist-2XbtBF3i.js";
import { G as createBlock, Vt as openBlock, ft as guardReactiveProps, nr as unref, nt as defineComponent, or as normalizeProps } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
import { t as v$1 } from "./core-U8nrK_TP.js";
	...
	return _createClass$1(ConnectedOverlayScrollHandler, [
		{
			...
			value: function bindScrollListener() {
				this.scrollableParents = Ut(this.element);
	...
	return _createClass(_default, [
		...
		},
		{
			...
			value: function get(parentInstance, slots) {
				...
				return l(computed) ? computed : null;
			}
		},
		{
			key: "_isMatched",
		...
		},
		{
			...
			value: function _recursive() {
				...
				children.forEach(function(child) {
					...
					else if (l(child.key)) components = components.concat(helpers.filter(function(c) {
...
//#endregion
//#region node_modules/@primeicons/core/dist/esm/icons/chevron-down.mjs
var o = {
	name: "chevron-down",
	meta: { tags: [
		"chevron-down",
...
//#endregion
//#region node_modules/@primeicons/vue/dist/esm/icons/chevron-down.mjs
var h = /* @__PURE__ */ defineComponent({
	name: "ChevronDown",
	inheritAttrs: !1,
	__name: "chevron-down",
	setup(i) {
		const { Icon: o$1 } = v$1(o);
...
var OverlayEventBus = v();
//#endregion
export { getVNodeProp as a, _default as i, h as n, ConnectedOverlayScrollHandler as r, OverlayEventBus as t };
