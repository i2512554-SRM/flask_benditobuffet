import { O as x, S as l, n as B } from "./object-EGs2rUUd.js";
import { R as $, St as ue, U as H, m as N, ot as at, v as S, w as gs } from "./dist-2XbtBF3i.js";
...
function useStyle(css) {
	...
	var load = function load(_css) {
		...
		if (!styleRef.value.isConnected) {
			...
			ue(styleRef.value, "data-primevue-style-id", _name);
			$(styleRef.value, _styleProps);
...
var BaseStyle = {
	...
	getThemeStyleSheet: function getThemeStyleSheet(params) {
		...
		if (this.style) {
			...
			var _css = gs(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["", ""])), x(this.style, { dt: N }));
...
//#endregion
export { BaseStyle as n, showInvalidLicenseBanner as t };
